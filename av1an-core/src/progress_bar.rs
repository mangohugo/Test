...
const INDICATIF_PROGRESS_TEMPLATE: &str = "{elapsed_precise:.bold.cyan} \
                                           {prefix}▐{wide_bar:.cyan/white.dim}▌ {percent:.bold.cyan} \
                                           {pos:.cyan} ({fps:.bold.cyan}, eta {fixed_eta:.cyan}{msg:.cyan})";
